...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-QSuNpGqX.mjs');
...
const tailwindCssHref = "/globe-stats/assets/tailwind-Bx6cha7f.css";
...
const $$splitComponentImporter = () => import('./index-DK6zsx88.mjs');
